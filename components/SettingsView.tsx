...
import { formatCurrency, translateTransactionType, formatCurrencyInput, parseCurrencyInput } from '../utils';
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
                ...
                <input 
                    ...
                    onChange={e => setInitialBalance(parseCurrencyInput(e.target.value))} 
                    required 
